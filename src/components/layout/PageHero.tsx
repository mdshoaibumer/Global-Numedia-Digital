        ...
        <div className="relative grid items-center gap-10 lg:grid-cols-[1.4fr_1fr]">
          <div>
            ...
            <p className="mt-4 max-w-xl text-white/70 md:text-lg">
              Book a free 30-minute strategy call. We'll audit your funnel, find
              the leaks, and map a 90-day growth plan.
            </p>
          </div>
          <div className="flex flex-col gap-3">
            <Link
              to="/contact"
              className="group inline-flex items-center justify-between gap-3 rounded-2xl bg-white px-6 py-5 text-[#06101f] transition hover:opacity-95"
            >
              <span>
                <span className="block text-[11px] uppercase tracking-[0.16em] text-[#06101f]/60">
                  Step 1
                </span>
            ...
            <a
              ...
              className="group inline-flex items-center justify-between gap-3 rounded-2xl border border-white/15 bg-white/5 px-6 py-5 backdrop-blur transition hover:bg-white/10"
            >
              <span>
                <span className="block text-[11px] uppercase tracking-[0.16em] text-white/60">
                  Or chat now
                </span>
                <span className="mt-0.5 block text-base font-semibold">
                  WhatsApp our team
