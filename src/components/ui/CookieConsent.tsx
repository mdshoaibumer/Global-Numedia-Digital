    ...
    <AnimatePresence>
      {show && (
        <motion.div
          ...
          className="fixed bottom-4 left-4 right-4 z-9999 mx-auto max-w-lg rounded-2xl border border-border bg-card/95 p-5 shadow-2xl backdrop-blur-xl md:right-6 md:left-auto"
        >
          <button
            onClick={decline}
