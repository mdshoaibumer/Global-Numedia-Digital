...
import { MessageCircle, Phone, Mail, MapPin, ArrowUpRight, Check } from "lucide-react";
...
const channels = [
  { icon: MessageCircle, label: "WhatsApp", value: "+1 (555) 123-4567", href: "https://wa.me/15551234567", sub: "Replies in under 2 minutes", accent: "text-success", bg: "bg-success/15" },
  { icon: Phone, label: "Call us", value: "+1 (555) 123-4567", href: "tel:+15551234567", sub: "Mon–Fri, 9am–7pm ET", accent: "text-accent", bg: "bg-accent/15" },
  { icon: Mail, label: "Email", value: "hello@Global Numedia.agency", href: "mailto:hello@Global Numedia.agency", sub: "We reply within 2 business hours", accent: "text-foreground", bg: "bg-foreground/10" },
];
            ...
            <div className="space-y-3">
              ...
              <div className="rounded-2xl border border-border bg-surface p-5">
                <div className="flex items-center gap-3 text-sm">
                  ...
                  <span className="text-foreground">Remote-first · New York · Dubai · London</span>
                </div>
              </div>
            </div>
          </Reveal>
